...
final GoRouter router = GoRouter(
      ...
      builder: (context, state) {
        ...
        return FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, userSnapshot) {
            ...
            switch (role) {
              case 'Admin': return const DashboardAdmin();
              case 'KP': return const DashboardKP();
              case 'Student': return const StudentDashboard();
              default: return const PlatformAwareLandingScreen();
            }
          },
        );
      },
  ...
  redirect: (context, state) {
    ...
    final bool isAuthenticating = location == '/login' || location == '/register' || location == '/forgot-password';
